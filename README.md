...
![cursor-spend ダッシュボード](docs/dashboard.png)
...
http://127.0.0.1:8765/ を開く。`--serve` 中は **5分ごとに自動更新**。タブが非表示のあいだは止める。

5分より短い間隔では自動では取らない。すぐ見たいときは右上 **更新**（または `GET /refresh`）。
